            ...
            //{
                switch (buttonType)
                {
                    case ButtonType.Engine:
                        if (SaveLoadData.Ins.DataGame.Coin >= SaveLoadData.Ins.DataGame.EnginePowCoinUp && SaveLoadData.Ins.DataGame.EnginePowLv < 150)
                        {
                            ...
                            SaveLoadData.Ins.DataGame.EnginePowCoinUp += 250;
                    ...
                    case ButtonType.Jetpack:
                        if (SaveLoadData.Ins.DataGame.Coin >= SaveLoadData.Ins.DataGame.JetpackPowCoinUp && SaveLoadData.Ins.DataGame.JetpackLv < 150)
                        {
                            ...
                            SaveLoadData.Ins.DataGame.JetpackPowCoinUp += 250;
                    ...
                    case ButtonType.Gold:
                        if (SaveLoadData.Ins.DataGame.Coin >= SaveLoadData.Ins.DataGame.CoinRewardCoinUp && SaveLoadData.Ins.DataGame.CoinRewardLv < 150)
                        {
                            ...
                            SaveLoadData.Ins.DataGame.CoinRewardCoinUp += 140;
