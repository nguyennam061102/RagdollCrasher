    ...
    public class CustomAdmob : MonoBehaviour, ICustomAds
    {
        ...
        private void InitComplete(InitializationStatus status)
        {
            if (debug)
            {
                ...
                {
                    ScreenWriter.Write(adapter.Key + " " + adapter.Value.InitializationState + " " +
        ...
        private void InterstitialFailed(object sender, AdFailedToLoadEventArgs e)
        {
            if (debug)
            {
                Debug.Log("Admob Interstitial Failed To Load ");
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void RewardedVideoFailed(object sender, AdFailedToLoadEventArgs adFailedToLoadEventArgs)
        {
            if (debug)
            {
                Debug.Log("Admob Rewarded Video Failed ");
